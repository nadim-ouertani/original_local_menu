import 'package:AlBaharMenu/bev_details_amwaj.dart';
import 'package:flutter/material.dart';

class AmwajBev extends StatelessWidget {
  @override
              ...
              child: GridView.count(
                ...
                children: <Widget>[
                  ...
                  _buildCard('CLASSIC SHAKES', '', 'assets/bev/4.jpg', false,
                      false, '', context),
                  _buildCard('HOMEMADE', '', 'assets/bev/homemade.jpg', false,
                      false, '', context),
      ...
      child: InkWell(
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => BevDetailsAmwaj(
                    assetPath: imgPath,
                    cookieprice: price,
                    cookiename: name,
                    cookiedes: des)));
